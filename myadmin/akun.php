...
<body>
 ...
 <td>
                                                 <span><a class="btn btn-warning btn-sm" href="editakun.php?id_akun='.$array['id_akun'].'"><i class="fa fa-edit (alias)"></i></a></span>

                                                

                                                  <span><a class="btn btn-danger btn-sm" onclick="return confirm(`Apakah Anda ingin Menghapus Id = '.$array['id_akun'].' ?`)"href="setting/hapusakun.php?id_akun='.$array['id_akun'].'" ><i  class="fa  fa-trash-o"></i></a></span>
