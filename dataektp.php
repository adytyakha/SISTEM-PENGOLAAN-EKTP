...
?></a>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-heading text-center mx-auto wow fadeInUp" data-wow-delay="300ms">
                        <h3>DATA E-KTP</h3>
                        <span>ANDA DAPAT MELIHAT DATA YANG SUDAH TERDAFTAR E-KTP</span>
    ...
    $query = mysqli_query($koneksi, "SELECT * FROM dataektp WHERE kk = '$kk' ");
                    ...
                    <div class="single-top-popular-course d-flex align-items-center flex-wrap mb-30 wow fadeInUp" data-wow-delay="500ms">
                        ...
                        <div class="popular-course-content">
                             ...
                             <h8>KK&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  &nbsp; &nbsp; &nbsp;:  '.$array['kk'].'</h8> <br>
                              <h8>Tgl Lahir&nbsp; :   '.$array['ttl'].'</h8> <br>
                            <h8>Pekrjaan&nbsp; :      '.$array['jenis_pekerjaan'].'</h8> <br><br>
                            
                             <span>Sudah Terdaftar  | '.$array['create'].'</span>
