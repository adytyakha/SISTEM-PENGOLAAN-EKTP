            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-heading text-center mx-auto wow fadeInUp" data-wow-delay="300ms">
                        <h3>Pendaftaran E-KTP</h3>
                        <span>Cek Kembali Data Diri Sebelum Klik Daftar</span>
  ...
  <?php
    ...
    while($data = mysqli_fetch_array($query)){
        ?>
            ...
            <form action="controll/proektp.php" method="POST">
              <div class="box-body">
      ...
      <div class="form-group has-feedback">
       ...
       <div class="form-group has-feedback">
        ...
        <div class="form-feedback">
          <button id="submitdaftar" name="submitdaftar" type="submit" class="btn btn-primary btn-block btn-flat">Daftar</button>
        </div>
